...
namespace Out_of_Office_API.Migrations
{
    ...
    [Migration("20240714182706_addProjectMembers")]
            ...
            modelBuilder.Entity("Out_of_Office_API.Data.ApprovalRequest", b =>
                {
                    ...
                    b.HasOne("Out_of_Office_API.Data.LeaveRequest", "LeaveRequest")
                        ...
                        .HasForeignKey("Out_of_Office_API.Data.ApprovalRequest", "LeaveRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectMember", b =>
                {
                    ...
                    b.HasOne("Out_of_Office_API.Data.Project", null)
                        .WithMany()
